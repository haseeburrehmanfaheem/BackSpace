  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            PostCard(
              Username: DemoValues.userName2,
              Title: DemoValues.postTitle2,
              Summary: DemoValues.postSummary2,
              PostDetails: DemoValues.postdetail,
              PostImage:
                  "https://firebasestorage.googleapis.com/v0/b/backspace-current.appspot.com/o/UserImages%2Farticle1.jpg?alt=media&token=d52a7b31-b60e-42df-9864-b5e50a57c52e",
            ),
            PostCard(
              Username: DemoValues.userName3,
              Title: DemoValues.postTitle3,
              Summary: DemoValues.postSummary3,
              PostDetails: DemoValues.postdetail2,
              PostImage:
                  "https://firebasestorage.googleapis.com/v0/b/backspace-current.appspot.com/o/UserImages%2Farticle2.jpg?alt=media&token=84f044d1-df54-4f37-bb0d-0bb9f8ea9102",
            ),
            PostCard(
              Username: DemoValues.userName4,
              Title: DemoValues.postTitle4,
              Summary: DemoValues.postSummary4,
              PostDetails: DemoValues.postdetail3,
              PostImage:
                  "https://firebasestorage.googleapis.com/v0/b/backspace-current.appspot.com/o/UserImages%2Farticle3.jpg?alt=media&token=98b8d2bf-743c-419d-b541-89322c71ea60",
            ),
          ],
        ),
    );
...
class _PostImage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Expanded(flex: 3, child: Image.network(postImage1));
  }
}
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(flex: 3, child: Image.network(postImage2)),
        ],
      ),
    );
  }
